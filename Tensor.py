...
class TensorProduct(object):
    ...
    def __init__(self, thingsToBeTensored):
        ...
        if (all(isinstance(vector, np.ndarray) for vector in self.thingsToBeTensored)):
            ...
            raise Exception(
                "The inputs for a tensor products should ALL be either vectors (states) or matrices (operators).")
    ...
    def denseTensorProduct(self):
        ...
        # TODO: what is .inputArray ? is not initialized
    ...
    def sparseTensorProduct(self):
        ...
        for productNumber in range(1, len(self.thingsToBeTensored)):
            ...
            newShape = (Product.Dimension[0] * BMatrix.Dimension[0],
                        Product.Dimension[1] * BMatrix.Dimension[1])
